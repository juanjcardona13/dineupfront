              ...
              <div class="pos-order" v-if="order.length > 0" v-for="order in order">
                <div class="pos-order-product">
                  ...
                  <div class="flex-1">
                    ...
                    <div class="d-flex">
                      <!-- DISMINUIR -->
                      <a href="#" class="btn btn-secondary btn-sm" v-on:click="(event) => deductQty(event, order.id)">
                      ...
                      <!-- AUMENTAR -->
                      <a href="#" class="btn btn-secondary btn-sm" v-on:click="(event) => addQty(event, order.id)">
                ...
                <div class="pos-order-price d-flex flex-column">
                  ...
                  <div class="text-end mt-auto"><a href="#"
                      v-on:click="(event) => toggleConfirmation(event, order.id, true)" class="btn btn-default btn-sm"><i
                ...
                <div class="pos-order-confirmation text-center d-flex flex-column justify-content-center"
                  ...
                  <div>
                    ...
                    <a href="#" v-on:click="(event) => removeOrder(event, order.id)"
                      class="btn btn-theme btn-sm width-100px">Yes</a>
                  </div>
                </div>
              </div>
              <!-- NO HAY PEDIDO -->
              ...
              <div class="modal-pos-product">
                ...
                <div class="modal-pos-product-info d-flex flex-column">
                  ...
                  <div class="d-flex mb-3">
                    <a href="#" class="btn btn-secondary" v-on:click="(event) => deductModalQty(event)">
                      <i class="fa fa-minus"></i>
                    </a>
                    <input type="text" class="form-control w-50px fw-bold mx-2 text-center" name="qty"
                      v-bind:value="modalQuantity" />
                    <a href="#" class="btn btn-secondary" v-on:click="(event) => addModalQty(event)">
                      <i class="fa fa-plus"></i>
                    </a>
                  </div>
                    ...
                    <div class="mb-2" v-if="modalData.options.size">
                      ...
                      <div class="option-list">
                        <div class="option" v-for="(size, index) in modalData.options.size">
                          <input type="radio" v-bind:id="'size[' + index + ']'" name="size" class="option-input"
                            v-model="modalSelectedSize" v-bind:value="size.text" />
                    ...
                    <div class="mb-2" v-if="modalData.options.addon">
                      ...
                      <div class="option-list">
                        <div class="option" v-for="(addon, index) in modalData.options.addon">
                          <input type="checkbox" v-bind:name="'addon[' + index + ']'" v-bind:value="addon.text"
                            v-model="modalSelectedAddon" class="option-input" v-bind:id="'addon[' + index + ']'" />
                  ...
                  <div class="row">
                    ...
                    <div class="col-8">
                      <button type="submit"
                        class="btn btn-theme fw-semibold d-flex justify-content-center align-items-center py-3 m-0 w-100">
                        Add to cart
